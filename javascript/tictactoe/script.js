...
const display = (function(){
    ...
    for(let i = 0;i<3;i++){
        for(let j = 0;j<3;j++){
            ...
            cell.textContent ="";
            cell.addEventListener("click",()=>{ cell.textContent = image(j,i,cell.textContent)});
...
const game = (function(){
    ...
    const checkWin = function(){
        for (let i = 0; i < 3; i++) {
            ...
            else if(Gameboard.gameboard[0][i] === Gameboard.gameboard[1][i] && 
        ...
        } else if (Gameboard.gameboard[0][2] === Gameboard.gameboard[1][1] && 
